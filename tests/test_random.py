...
class TestRandomControls(unittest.TestCase):
  ...
  def test_prompts(self):
    ...
    self.assertEqual(k.get_prompts(), {
      0: ['happy landscape', 'horse:2', 'vaporwave dragon by Yayoi Kusama:8'],
      64: ['happy landscape', 'horse:2', 'vaporwave house by Yayoi Kusama:2',
           'vaporwave dragon by Yayoi Kusama:6'],
      74: ['happy landscape', 'horse:2', 'vaporwave house by Yayoi Kusama:4',
           'vaporwave dragon by Yayoi Kusama:4'],
      84: ['happy landscape', 'horse:2', 'vaporwave house by Yayoi Kusama:6',
           'vaporwave dragon by Yayoi Kusama:2'],
      94: ['happy landscape', 'horse:2', 'vaporwave house by Yayoi Kusama:8'],
      163: ['happy landscape', 'horse:2', 'vaporwave dragon by Yayoi Kusama:2',
            'vaporwave house by Yayoi Kusama:6'],
      173: ['happy landscape', 'horse:2', 'vaporwave dragon by Yayoi Kusama:4',
            'vaporwave house by Yayoi Kusama:4'],
      183: ['happy landscape', 'horse:2', 'vaporwave dragon by Yayoi Kusama:6',
            'vaporwave house by Yayoi Kusama:2'],
      193: ['happy landscape', 'horse:2', 'vaporwave dragon by Yayoi Kusama:8']
    })

  def test_multiprompts(self):
    k = Keyframer()
    k.read_script("""
      00000 RP SEED 1234
      00000 RP BACKGROUND ['cat']
      00000 RP ARTISTS ['Yayoi Kusama', 'Mary Cassatt', 'Beeple']
      00000 RP ARTISTS_PICK 2
      00000 RP MODIFIERS ['vaporwave', 'tilt shift', 'flaming']
      00000 RP MODIFIERS_PICK 2
      00000 RP SUBJECTS ['house', 'dragon', 'car']
      00000 RP SUBJECTS_PICK 2
      00000 RP CYCLE 45-45
      00000 RP FADE []
      00000 RP WEIGHT 1
      00000 RP ON
      # That's all!
